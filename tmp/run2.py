...
from app.services import s_bs2
from typing import Optional
from PyPDF2 import PdfReader
from app.llm import ai_bs2
...
def bs_textpdf(file_path: str, pdf_name: str, pdf_folder: str) -> Optional[dict]:
    try:
        ...
        ai_res = ai_bs2.bs_ai_txt(output_json)
...
def my_task():
    ...
    upload_folder = Path("./tmp/v62").resolve()
    finish_folder = Path("./tmp/v62done").resolve()
                    ...
                    try:
                        ...
                        try:
                            if is_textpdf(oFile):  # Ensure oFile is a Path object
                                ...
                                bs_data = s_bs2.bs_imgpdf(pdf_name, pdf_folder)
                                _type = "img-pdf"
                        except Exception as e:
